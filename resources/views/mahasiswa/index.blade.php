                        ...
                        <div class="d-flex flex-wrap">
                            @php
                                ...
                                foreach ($mahasiswas as $mhs) {
                                    $kelasCount[$mhs->kelas] = isset($kelasCount[$mhs->kelas])
                                        ? $kelasCount[$mhs->kelas] + 1
                                        : 1;
                                }
                            @endphp
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('mahasiswa.destroy', $mhs->nim) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-hapus btn-sm" title="Hapus"
